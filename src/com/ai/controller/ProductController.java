...
public class ProductController {
	...
	*/
	...
	public String deleteProduct(@PathVariable(value = "productId") String productId) {
		...
		java.nio.file.Path path = Paths.get("C:/Users/Ismail/workspace/ShoppingCart/src/main/webapp/WEB-INF/resource/images/products/" + productId + ".jpg");
	...
	public String addProduct(@Valid @ModelAttribute(value = "productFormObj") Product product, BindingResult result) {
		...
		if (image != null && !image.isEmpty()) {
			java.nio.file.Path path = Paths.get("C:/Users/Ismail/workspace/ShoppingCart/src/main/webapp/WEB-INF/resource/images/products/"
